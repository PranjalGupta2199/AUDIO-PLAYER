...
This file currently shows the metadata of three types of files ('.mp3','.ogg','.flac'). It can also play other formats but currently it is supported for the above three formats.
